...
from xrally_kubernetes.tasks.scenarios.volumes import hostpath


class CreateAndDeleteHostPathVolumeTestCase(test.TestCase):

    def setUp(self):
        super(CreateAndDeleteHostPathVolumeTestCase, self).setUp()
        context = {
            "iteration": 1,
            "kubernetes": {
                "namespaces": ["ns"],
        ...
        self.scenario = hostpath.CreateAndDeletePodWithHostPathVolume(context)
...
class CreateCheckAndDeleteHostPathVolumeTestCase(test.TestCase):

    def setUp(self):
        super(CreateCheckAndDeleteHostPathVolumeTestCase, self).setUp()
        context = {
            "iteration": 1,
            "kubernetes": {
                "namespaces": ["ns"],
